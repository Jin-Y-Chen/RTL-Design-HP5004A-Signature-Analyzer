...
REM
REM Generated by Vivado on Thu May 07 18:07:09 -0400 2026
...
echo "xvhdl --incr --relax -prj hp5004a_tb_vhdl.prj"
call xvhdl  --incr --relax -prj hp5004a_tb_vhdl.prj -log xvhdl.log
